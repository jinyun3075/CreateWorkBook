			...
			<div class="jumbotron" style="padding-top:20px;">
				<form method="post" action="joinAction.jsp">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="" name="userID" maxlength="20">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1" class="text-uppercase">암호</label>
						<input type="password" class="form-control" placeholder="" name="userPW" maxlength="20">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1" class="text-uppercase">별명</label>
						<input type="text" class="form-control" placeholder="" name="name" maxlength="20">
					</div>	
