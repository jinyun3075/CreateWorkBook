...
public class Work2DAO {
	...
	public ArrayList<Work2DTO> getList(String work1Id, String userId) {
		String sql ="SELECT work2id,work2_qw FROM work2 WHERE userid=? AND work1id=? ORDER BY work2id";
	...
	public int update(Work2DTO dto) {
		String sql ="UPDATE work2 "
				+ "SET work2_qw=?, work2_view1=?, work2_view2=?, work2_view3=?, work2_view4=?, work2_value=? "
